...
@pytest.mark.slow
def test_submit_ogdc_viz_recipe_e2e(test_viz_workflow_recipe_directory):
    """Test that an ogdc visualization recipe can be submitted and executed successfully (end-to-end, slow)."""
...
@pytest.mark.order(after="test_submit_ogdc_viz_recipe_e2e")
@pytest.mark.slow
